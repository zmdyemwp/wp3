...
public class ZoomControlBar extends ZoomControl {
    ...
    protected void onLayout(
        ...
        Log.i(TAG,"onLayout left:"+left+" top:"+top+" right:"+right+" bottom:"+bottom+" mWidth:"+mWidth+" mIconWidth:"+mIconWidth+" mTotalIconWidth:"+mTotalIconWidth+" mSliderLength:"+mSliderLength);
