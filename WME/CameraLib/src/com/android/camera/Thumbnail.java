...
public class Thumbnail {
    ...
    public void saveTo(File file) {
        ...
        synchronized (sLock) {//2012/4/20 Jinsheng sync ICS4.0.4 code 
            try {
    ...
    public static Thumbnail loadFrom(File file) {
        ...
        synchronized (sLock) {//2012/4/20 Jinsheng sync ICS4.0.4 code begin
            try {
