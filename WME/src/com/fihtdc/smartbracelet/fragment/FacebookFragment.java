...
class FacebookFragment extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(null!=com.fihtdc.smartbracelet.facebook.Utility.mFacebook){
        	 com.fihtdc.smartbracelet.facebook.Utility.mFacebook.authorizeCallback(requestCode, resultCode, data);
        }
