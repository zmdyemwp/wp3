...
public class SlidingActivityHelper {
    ...
    public void setBehindContentView(Fragment v, LayoutParams params) {
        // mViewBehind = v;
        // mSlidingMenu.setMenu(mViewBehind);
    }

    // public void addSlide(FragmentManager fm, Fragment f, float
    // screenWidthWeight) {
    // if (mCurrentSlideIndex == -1) mCurrentSlideIndex++;
    // int slideId = mLastSlideId.incrementAndGet();
    // FrameLayout container = new FrameLayout(getContext());
    // container.setId(slideId);
    // mSlideList.add(new Slide(slideId, f, container, screenWidthWeight));
    //
    // mContent.addView(container);
    // fm.beginTransaction().add(slideId, f).commit();
    // }
