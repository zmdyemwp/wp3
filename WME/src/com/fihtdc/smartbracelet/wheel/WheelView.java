...
package com.fihtdc.smartbracelet.wheel;
...
import com.fihtdc.smartbracelet.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        visibleItems = a.getInt(R.styleable.WheelView_visible_count, DEF_VISIBLE_ITEMS);
        a.recycle();
        initData(context);
    }
    ...
    private int getDesiredHeight(LinearLayout layout) {
        ...
        int desired = itemHeight * visibleItems - itemHeight * ITEM_OFFSET_PERCENT / 50 + 2
                * PADDING_VERTICAL;
    ...
    private boolean rebuildItems() {
        ...
        // JimmyChen Fixed Crash Log:
        /*
         * java.lang.NullPointerException at
         * com.fihtdc.smartbracelet.wheel.WheelView
         * .rebuildItems(WheelView.java:756) at
         * com.fihtdc.smartbracelet.wheel.WheelView
         * .updateView(WheelView.java:785) at
         * com.fihtdc.smartbracelet.wheel.WheelView.onDraw(WheelView.java:556)
         */
        ...
        try {
            ...
            if (range == null) {
                LogApp.Loge("rebuildItems range == null");
            }
            if (itemsLayout == null) {
                LogApp.Loge("rebuildItems itemsLayout == null");
            }
            if (!updated) {
            ...
            LogApp.Loge("rebuildItems Crashed" + e.getMessage());
        }
        return updated;
    }
