...
public class CameraButtonIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //2012/3/1 Jinsheng add for IRMI.B-906 begin
        //Try the check if camera device is using by other app
        int cameraNums = SystemProperties.getInt("fih_openedCams", 0);
        Log.i("CameraButtonIntentReceiver","opened camera numbers:"+cameraNums);
        if(cameraNums != 0){
            return;
        }
        //2012/3/1 Jinsheng add for IRMI.B-906 end
