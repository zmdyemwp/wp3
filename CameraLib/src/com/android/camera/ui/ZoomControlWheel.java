...
public class ZoomControlWheel extends ZoomControl {
    ...
    protected void onLayout(
        ...
        if(indicatorZero==true)
        {
            layoutIcon(mZoomSlider, Math.toRadians(MAX_SLIDER_ANGLE));
            //Log.e(TAG, "layoutIcon indicatorZero==true  ");//peiming test
            indicatorZero=false;
        }
        else
        {
            layoutIcon(mZoomSlider, getSliderDrawAngle(mSliderRadians));
            //Log.e(TAG, "layoutIcon indicatorZero==flase   ");//peiming test
        }
