...
public class LocationManager {
    ...
    private class LocationListener
        ...
        public void onLocationChanged(Location newLocation) {
            Log.i(TAG,"onLocationChanged Latitude:"+newLocation.getLatitude()+"  Longitude:"+newLocation.getLongitude());
			...
			//2012/6/5 Jinsheng modify for IPD.B-3568 begin
            if (mListener != null && mRecordLocation /*&&
                ...
                if(mProvider!=null)Log.i(TAG,"location provider:"+mProvider);
            }
			//2012/6/5 Jinsheng modify for IPD.B-3568 end
            if (!mValid) {
